...
chequemodifier(devise:String,montant:Number){
  return this.http.get<Cheque>('http://localhost:8080/cheque/'+devise+'/'+montant);
}

montantmodifier(montant:Number){
  return this.http.get<Cheque>('http://localhost:8080/chequeMontant/'+montant);
}

devisemodifier(devise:String){
  return this.http.get<Cheque>('http://localhost:8080/chequeDevise/'+devise);
}
...
ajouterchequeclient(numeroCompte:Number,cheque:Cheque){
  return this.http.put<Client>('http://localhost:8080/ajouterchequeclient/'+numeroCompte,cheque);
}

ajouterChequeBanque(numCheque:Number,banque:BanqueDestinataire) {
  return this.http.put<Banque>('http://localhost:8080/ajouterchequebanque/'+numCheque,banque);
}
