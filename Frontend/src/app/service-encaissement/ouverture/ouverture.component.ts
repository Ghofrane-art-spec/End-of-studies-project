...
import { Banque } from 'src/app/banque';
...
const encaissementForm = document.querySelector('#encaissement-form') as HTMLElement;
  ...
  modifierCheque() {
    ...
    console.log("modifier starts"); 
    if((montant!=null)&&(devise!=null)){
    this.us.chequemodifier( devise, montant).subscribe((ch: Cheque) => {
        console.log("part 1 ends"); 
        console.log(ch);
        this.us.enregistrerCheque(this.cheque.numCheque,ch).subscribe((Cheque: Cheque) => {
    ...
    this.us.devisemodifier( devise).subscribe((ch: Cheque) => {
      console.log("part 1 ends"); 
      console.log(ch);
      this.us.enregistrerCheque(this.cheque.numCheque,ch).subscribe((Cheque: Cheque) => {
        console.log("part 2 begins"); 
    ...
    this.us.montantmodifier(montant).subscribe((ch: Cheque) => {
      console.log("part 1 ends"); 
      console.log(ch);
      this.us.enregistrerCheque(this.cheque.numCheque,ch).subscribe((Cheque: Cheque) => {
        console.log("part 2 begins"); 
  ...
  }else{console.log("modifier ends");}
  }
